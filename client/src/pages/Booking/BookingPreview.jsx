        ...
        <Modal.Body>
          {selectedTicket && (
            <div>
              ...
              <p><strong>Loại vé:</strong> {selectedTicket.name}</p>
              <p><strong>Giá vé:</strong> ${selectedTicket.price.toFixed(2)}</p>
              <p><strong>Khuyến mãi:</strong> {selectedTicket.sales}</p>
              <p><strong>Chi tiết vé:</strong> {selectedTicket.description}</p>
            </div>
          )}
        </Modal.Body>
        <Modal.Footer>
