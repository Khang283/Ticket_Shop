...
export default function Footer() {
    return (
        <>
            <footer class="p-4 bg-amber-900 text-white sm:p-6 dark:bg-gray-800">
                <div class="mx-auto max-w-screen-xl">
                            ...
                            <ul class="text-gray-300 dark:text-gray-400">
                                <li class="mb-4">
                                    <span class="text-gray-300 dark:text-gray-400">
                                        <span class="font-medium text-white">Địa chỉ:</span> 01 Công xã Paris, Bến Nghé, Quận 1,Thành phố Hồ Chí Minh
                                    </span>
                                </li>
                                <li>
                                    <span class="text-gray-300 dark:text-gray-400 "><span class="font-medium text-white">Hotline:</span> 19001509</span>
                                </li>
                                <li>
                                    <span class="text-gray-300 dark:text-gray-400"><span class="font-medium text-white">E-mail:</span> datvenhathoducba@info.com</span>
                                </li>
                            </ul>
                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <span class="text-sm text-white sm:text-center dark:text-gray-400">© 2024 <Link href="/home" class="hover:underline">Ticket™</Link>. All Rights Reserved.
                        </span>
